...
@section('content')
    ...
    <form method="POST" action="{{ route('aset.store') }}" class="bg-white border rounded p-4 space-y-4">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="no_serial" value="{{ old('no_serial') }}" class="mt-1 w-full border rounded px-3 py-2">
            </div>
        ...
        <div>
            ...
            {{-- <textarea name="status_kondisi" rows="4" class="mt-1 w-full border rounded px-3 py-2"
