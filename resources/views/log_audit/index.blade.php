        ...
        <div class="bg-white rounded-xl shadow-sm border p-4 mb-4">
            <form class="grid grid-cols-1 md:grid-cols-12 gap-3">
                <div class="md:col-span-3">
                    <input name="q" value="{{ $q }}" class="w-full border rounded-lg px-3 py-2 text-sm"
                        placeholder="Cari tabel / referensi / ID">
                </div>

                <div class="md:col-span-2">
                    <select name="aksi" class="w-full border rounded-lg px-3 py-2 text-sm">
                ...
                <div class="md:col-span-2">
                    <select name="nama_tabel" class="w-full border rounded-lg px-3 py-2 text-sm">
                ...
                <div class="md:col-span-1">
                    <button class="w-full bg-gray-800 text-white rounded-lg py-2 text-sm hover:bg-gray-900">
                        Go
                    </button>
                </div>
            </form>
