...
@section('content')
    ...
    <form method="post" action="{{ route('gudang.store') }}" class="bg-white border rounded p-4 space-y-4">
        @csrf
        ...
        <div class="flex gap-2">
            <a href="{{ route('gudang.index') }}" class="px-3 py-2 rounded border text-sm hover:bg-gray-50">Batal</a>
