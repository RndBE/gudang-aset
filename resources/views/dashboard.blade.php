        ...
        @php
            ...
            $bottomCards = [
                ...
                [
                    ...
                    'value' => $asetDitugaskan ?? 12,
                    'pill' => 'bg-amber-100 text-amber-700',
                    'icon' => 'penugasan_aset',
                ],
                [
                    'label' => 'Aset Dipinjamkan',
                    'value' => $asetDipinjamkan ?? 34,
                    'pill' => 'bg-purple-100 text-purple-700',
                    'icon' => 'peminjaman_aset',
                ],
                [
                    'label' => 'Aset Dihapus',
                    'value' => $asetDihapus ?? 56,
