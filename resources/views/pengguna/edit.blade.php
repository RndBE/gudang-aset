    ...
    <div class="bg-white border rounded p-4 max-w-3xl">
        ...
        <form method="post" action="{{ route('pengguna.update', $pengguna) }}" class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
                ...
                <input name="nama_lengkap" value="{{ $pengguna->nama_lengkap }}" class="w-full border rounded px-3 py-2"
                    required>
            </div>

            <div>
                <label class="block text-sm mb-1">Username</label>
                <input name="username" value="{{ $pengguna->username }}" class="w-full border rounded px-3 py-2" required>
            </div>

            <div>
                <label class="block text-sm mb-1">Email</label>
                <input name="email" value="{{ $pengguna->email }}" class="w-full border rounded px-3 py-2">
            </div>

            <div>
                <label class="block text-sm mb-1">Telepon</label>
                <input name="telepon" value="{{ $pengguna->telepon }}" class="w-full border rounded px-3 py-2">
            </div>

            <div>
                <label class="block text-sm mb-1">NIP/NRK</label>
                <input name="nip_nrk" value="{{ $pengguna->nip_nrk }}" class="w-full border rounded px-3 py-2">
            </div>

            <div>
                <label class="block text-sm mb-1">Pangkat</label>
                <input name="pangkat" value="{{ $pengguna->pangkat }}" class="w-full border rounded px-3 py-2">
            </div>

            <div>
                <label class="block text-sm mb-1">Jabatan</label>
                <input name="jabatan" value="{{ $pengguna->jabatan }}" class="w-full border rounded px-3 py-2">
            </div>
