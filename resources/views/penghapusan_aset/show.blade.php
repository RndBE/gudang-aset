        ...
        <div class="bg-white border rounded overflow-hidden">
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="font-medium">{{ $data->instansi->nama ?? '-' }}, {{ $data->instansi->alamat ?? '-' }}</div>
                </div>
                <div>
                    <div class="text-xs text-gray-500">Nomor Penghapusan</div>
                    <div class="font-medium">{{ $data->nomor_penghapusan }}</div>
                </div>
                ...
                <div>
                    ...
                    <div class="font-medium">{{ ucfirst($data->metode) }}</div>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mt-1 p-3 border rounded bg-gray-50 text-sm">
                        {{ $data->alasan ?? '-' }}
                    </div>
                </div>
